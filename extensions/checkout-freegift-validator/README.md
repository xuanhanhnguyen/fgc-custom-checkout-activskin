# Free gift checkout validator

Validates Active Skin free gifts against the current checkout lines and Prismic
...
This extension is a checkout UX and remediation layer. A Cart and Checkout
Validation Function should also enforce free-gift eligibility server-side,
especially for accelerated checkout methods where cart line mutations aren't
available.
