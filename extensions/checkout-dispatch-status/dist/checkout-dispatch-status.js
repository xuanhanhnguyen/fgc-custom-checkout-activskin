...
${errorInfo.componentStack}`);
  ...
  // extensions/checkout-dispatch-status/src/Checkout.tsx
  var import_react11 = __toESM(require_react());
  var import_jsx_runtime4 = __toESM(require_jsx_runtime());
  var checkoutLineItem = reactExtension(
    "purchase.checkout.cart-line-item.render-after",
    () => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Extension, {})
  );
  var orderLineItem = reactExtension(
    "customer-account.order-status.cart-line-item.render-after",
    () => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Extension, {})
  );
  var thankyouLineItem = reactExtension(
    "purchase.thank-you.cart-line-item.render-after",
    () => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Extension, {})
  );
  function Extension() {
    const [dispatch, setDispatch] = (0, import_react11.useState)("");
    const _a = useTarget(), {
      merchandise: _b
    ...
    (0, import_react11.useEffect)(() => {
      var _a2, _b2, _c2;
      const isFreeGift = ((_a2 = attributes == null ? void 0 : attributes.find((v) => (v == null ? void 0 : v.key) === "_rule_id")) == null ? void 0 : _a2.value) || "";
      const hasDispatchStatus = ((_b2 = attributes == null ? void 0 : attributes.find((v) => (v == null ? void 0 : v.key) === "Dispatch status")) == null ? void 0 : _b2.value) || "";
      if (!isFreeGift && !hasDispatchStatus) {
        const status = ((_c2 = attributes == null ? void 0 : attributes.find((v) => (v == null ? void 0 : v.key) === "_status")) == null ? void 0 : _c2.value) || "";
        let _dispatch = "";
        switch (status) {
    ...
    if (!dispatch)
      return null;
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { size: "small", appearance: "subdued", children: dispatch });
  }
})();
//# sourceMappingURL=checkout-dispatch-status.js.map
