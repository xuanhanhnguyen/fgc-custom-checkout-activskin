...
${errorInfo.componentStack}`);
  ...
  // node_modules/@shopify/ui-extensions-react/build/esm/surfaces/checkout/hooks/target.mjs
  ...
  function App() {
    ...
    useBuyerJourneyIntercept(({ canBlockProgress }) => {
      if (canBlockProgress) {
        if (address.address1 && address.address1.length > 40 || address.address2 && address.address2.length > 40) {
          return {
            behavior: "block",
  ...
  // extensions/checkout-ui/src/CheckoutLineItem.tsx
  var import_react14 = __toESM(require_react());
  var import_jsx_runtime5 = __toESM(require_jsx_runtime());
  var CheckoutLineItem_default = reactExtension(
    "purchase.checkout.cart-line-item.render-after",
    () => /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Extension, {})
  );
  function Extension() {
    const [dispatch, setDispatch] = (0, import_react14.useState)("");
    const _a = useTarget(), {
      merchandise: _b
    } = _a, _c = _b, { title } = _c, data = __objRest(_c, ["title"]), {
      attributes
    } = _a;
    (0, import_react14.useEffect)(() => {
      var _a2;
      const status = ((_a2 = attributes == null ? void 0 : attributes.find((v) => (v == null ? void 0 : v.key) === "_status")) == null ? void 0 : _a2.value) || "";
      let _dispatch = "Expected to ship in 3-5 business days";
      switch (status) {
    ...
    if (!dispatch)
      return null;
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Text2, { visibility: "hidden", size: "small", appearance: "subdued", children: dispatch });
  }

  // extensions/checkout-ui/src/ThankYou.tsx
  var import_jsx_runtime6 = __toESM(require_jsx_runtime());
  var ThankYou = reactExtension("purchase.thank-you.block.render", () => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(GtsBlock, {}));
  var OrderStatus = reactExtension(
    "customer-account.order-status.block.render",
    () => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(GtsBlock, {})
  );
  function GtsBlock() {
    ...
    function addWorkingDate(date_add) {
      let date_today = /* @__PURE__ */ new Date();
    ...
    const discount = ((_a = cost == null ? void 0 : cost.totalAmount) == null ? void 0 : _a.current.amount) - (cost.subtotalAmount.current.amount + cost.totalTaxAmount.current.amount + cost.totalShippingAmount.current.amount);
    return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(BlockStack2, { display: "none", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(TextBlock2, { id: "gts-order", translate: "no", children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Text2, { id: "gts-o-id", children: (_b = orderConfirmation == null ? void 0 : orderConfirmation.current) == null ? void 0 : _b.number }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Text2, { id: "gts-o-domain", children: "activeskin.com.au" }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Text2, { id: "gts-o-email", children: ((_d = (_c = buyerIdentity == null ? void 0 : buyerIdentity.customer) == null ? void 0 : _c.current) == null ? void 0 : _d.email) || (buyerIdentity == null ? void 0 : buyerIdentity.email) }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Text2, { id: "gts-o-country", children: localization.country.current.isoCode }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Text2, { id: "gts-o-currency", children: cost.subtotalAmount.current.currencyCode }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Text2, { id: "gts-o-total", children: i18n.formatCurrency((_e = cost == null ? void 0 : cost.totalAmount) == null ? void 0 : _e.current.amount) }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Text2, { id: "gts-o-shipping-total", children: i18n.formatCurrency(cost.totalShippingAmount.current.amount) }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Text2, { id: "gts-o-tax-total", children: i18n.formatCurrency(cost.totalTaxAmount.current.amount) }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Text2, { id: "gts-o-discounts", children: i18n.formatCurrency(discount) }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Text2, { id: "gts-o-est-ship-date", children: shippingDate }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Text2, { id: "gts-o-est-delivery-date", children: deliveryDate }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Text2, { id: "gts-o-has-preorder", children: "N" }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Text2, { id: "gts-o-has-digital", children: "N" }),
      (_f = lines == null ? void 0 : lines.current) == null ? void 0 : _f.map((line, index) => {
        var _a2, _b2;
        return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(TextBlock2, { id: "gts-item", children: [
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Text2, { id: "gts-i-name", children: line == null ? void 0 : line.merchandise.title }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Text2, { id: "gts-i-price", children: i18n.formatCurrency((_b2 = (_a2 = line == null ? void 0 : line.cost) == null ? void 0 : _a2.totalAmount) == null ? void 0 : _b2.amount) }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Text2, { id: "gts-i-quantity", children: line == null ? void 0 : line.quantity })
        ] }, index);
      })
    ] }) });
  }
